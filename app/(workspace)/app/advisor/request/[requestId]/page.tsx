...
const SOURCE_CONTEXT_LABELS: Record<string, string> = {"advisor-request": "Basic Advisor Request",loan_readiness: "Loan Readiness",prequalification: "Bank Readiness Review",report: "Financial Report",action_plan: "Action Plan"};
