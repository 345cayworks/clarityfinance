...
CREATE TABLE IF NOT EXISTS profiles (
  ...
  monthly_gross_income numeric DEFAULT 0,
  monthly_net_income numeric DEFAULT 0,
  other_income_amount numeric DEFAULT 0,
  other_income_description text,
  loan_purpose text,
  requested_loan_amount numeric DEFAULT 0,
  desired_loan_term_years integer,
  property_type text,
  property_location text,
  property_identified boolean DEFAULT false,
  purchase_agreement_available boolean DEFAULT false,
  primary_bank_name text,
  existing_bank_relationship boolean DEFAULT false,
  bank_statements_available boolean DEFAULT false,
  missed_payments_history boolean DEFAULT false,
  ...
  has_debt_statements boolean DEFAULT false,
  has_credit_report boolean DEFAULT false,
  has_purchase_agreement boolean DEFAULT false,
  has_valuation boolean DEFAULT false,
  has_down_payment_proof boolean DEFAULT false,
  has_business_financials boolean DEFAULT false,
  created_at timestamp DEFAULT now(),
  updated_at timestamp DEFAULT now()
);
