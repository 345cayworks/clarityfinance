...
export const handler: Handler = async (event) => {
  ...
  const advisorRequests = await sql`
    SELECT ar.id, ar.user_id, ar.name, ar.email, ar.phone, ar.topic, ar.urgency, ar.message, ar.status, ar.consent_to_review,
           ar.created_at, ar.updated_at, ar.assigned_advisor_id, ar.assigned_advisor_email, ar.assigned_at, ar.assigned_by,
